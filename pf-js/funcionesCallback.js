...
//?for each
//No todos los datos del foreach son obligatorios son datos a los que puedo acceder
...
/** 
 * ? Map
 * Ejecuta una funcion sobre cada elemento de un array y devuleve un nuevo array con el resultado 
 */
...
/** 
 *? Filter
 * Sirve para filtrar elementos de un array, recibe una funccion de callback donde lo que retornemos debe ser una expresion boolean y los elementos del array que cumplan esa condicion seran guardados en un nuevo array
 */
...
const multiplosDeTres = numeros.filter((numeros) => numeros % 3 == 0);
